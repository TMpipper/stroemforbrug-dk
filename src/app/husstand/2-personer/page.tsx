...
const faqs = [
  { question: "Hvor meget strøm bruger 2 personer om året?", answer: "Et par bruger typisk 2.500-3.500 kWh/år uden varmepumpe. I en lejlighed 2.000-3.000 kWh (3.720-5.580 kr.), i et hus 2.500-3.500 kWh (4.650-6.510 kr.)." },
  ...
  { question: "Hvad koster strøm for 2 personer om måneden?", answer: "Med 1,86 kr./kWh koster det ca. 387-543 kr./md. i et hus og 309-465 kr./md. i en lejlighed (begge uden varmepumpe)." },
  { question: "Hvor meget sparer et par ved at skifte elselskab?", answer: "Med 3.000 kWh/år sparer I ca. 354 kr./år ved at skifte fra en gennemsnitlig elaftale (1,95 kr./kWh alt i alt) til Altid Energi (1,83 kr./kWh inkl. abonnement). Det tager 5 minutter at skifte." },
  ...
  { question: "Påvirker hjemmekontor strømforbruget?", answer: "Ja, en computer der kører 8 timer/dag bruger 50-200 kWh/år ekstra. Med ekstra belysning og evt. ekstra varme i kontoret kan det samlede ekstra forbrug nå 150-400 kWh/år (279-744 kr.)." },
];
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <QuickAnswer>
          <p>
            ...
            svarende til 4.650-6.510 kr. ved 1,86 kr./kWh. I en lejlighed er
        ...
        <div className="prose-editorial">
          ...
          <table>
            ...
            <tbody>
              <tr><td><strong>Lejlighed (60-80 m²)</strong></td><td>2.000-3.000 kWh</td><td>3.000+ kWh</td><td>3.720-5.580 kr.</td></tr>
              <tr><td><strong>Rækkehus (80-110 m²)</strong></td><td>2.300-3.200 kWh</td><td>3.200+ kWh</td><td>4.278-5.952 kr.</td></tr>
              <tr><td><strong>Hus (100-150 m²)</strong></td><td>2.500-3.500 kWh</td><td>3.500+ kWh</td><td>4.650-6.510 kr.</td></tr>
            </tbody>
          </table>
          ...
          <table>
            ...
            <tbody>
              <tr><td><strong><Link href="/koeleskab/">Køl og frys</Link></strong></td><td>200-350 kWh</td><td>372-651 kr.</td></tr>
              <tr><td><strong>Madlavning</strong></td><td>200-350 kWh</td><td>372-651 kr.</td></tr>
              <tr><td><strong><Link href="/vaskemaskine/">Tøjvask</Link> + <Link href="/toerretumbler/">tørring</Link></strong></td><td>200-400 kWh</td><td>372-744 kr.</td></tr>
              <tr><td><strong><Link href="/opvaskemaskine/">Opvaskemaskine</Link></strong></td><td>150-250 kWh</td><td>279-465 kr.</td></tr>
              <tr><td><strong>Underholdning + IT</strong></td><td>200-400 kWh</td><td>372-744 kr.</td></tr>
              <tr><td><strong>Belysning</strong></td><td>150-250 kWh</td><td>279-465 kr.</td></tr>
              <tr><td><strong>Varmt vand + øvrige</strong></td><td>500-800 kWh</td><td>930-1.488 kr.</td></tr>
            </tbody>
          </table>
          ...
          <p>
            ...
            (279-744 kr.) pr. person der arbejder hjemme. En <Link href="/laptop/">laptop</Link> bruger
        ...
        <AffiliateCta kwh={3500} household="en husstand med to voksne" />
